...
public class LokasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationProviderClient = LocationServices.getFusedLocationProviderClient(LokasiActivity.this);
            ...
            locationProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if(location !=null) {
                        ...
                        Toast.makeText(getApplicationContext(), "lokasi tidak di temukan", Toast.LENGTH_SHORT).show();
                    }
                }
